    ...
    return (
        <section className="my-20">
            ...
            <div className="mx-auto  md:w-4/12">
                <h1 className="italic mt-[60px] text-center text-xl text-[#D99904] font-medium">---What Our Clients Say---</h1>
                <h1 className="text-4xl text-center font-medium mt-10 border-y-4 py-4 border-gray-300 mb-16">TESTIMONIALS</h1>
            </div>
                    ...
                    >
                        <div className="flex flex-col items-center mx-24 my-16">
                            ...
                            <Rating
                                ...
                                readOnly
                            />
                            <svg className="w-16" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none">
